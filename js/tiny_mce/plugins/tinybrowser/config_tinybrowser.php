...
// This is for the write back to the input field.
...
$tinybrowser['path']['image'] = '/CMS_demo/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/CMS_demo/uploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/CMS_demo/uploads/files/'; // Other files location
...
$tinybrowser['filetype']['file']  = '*.pdf, .doc, .xls, .docx'; // Other file types
