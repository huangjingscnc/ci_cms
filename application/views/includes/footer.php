			...
			<div class="right">
				<div class="shop">
					...
					<a href="<?php echo base_url(); ?>page/shop" class="preview" id="" title="">
						<img src="<?php echo base_url(); ?>graphics/shoppreview_ox.jpg" alt="shoppreview_ox" width="208" height="130" />
					</a>
					<a href="<?php echo base_url(); ?>page/shop" class="button" id="" title="">VISIT OUR SHOP</a>
...
//print_r($sam);
	...
	extract($row);			
			...
			echo "		
				...
				<h4><a href='galleries/$sam->gallery_ID' class='' id='' title=''>$sam->gallery_name</a></h4>
			</div><!-- end gallery -->";
				 }
		//echo $pageID;
		endforeach;
